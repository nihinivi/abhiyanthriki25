    ...
    <section className="w-screen min-h-screen">
      <div className="mx-auto max-w-[1920px] px-6 py-0 h-full">
        ...
        <div className="mt-[40px] md:mt-[60px] flex flex-col md:flex-row md:items-start items-center md:justify-between gap-8 md:gap-6">
          {/* Tech card */}
          <div className="relative w-[80vw] md:w-[28%] max-w-[460px] rounded-[18px] overflow-hidden transform-gpu transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] shadow-[0_0_0_rgba(0,0,0,0)] hover:shadow-[0_22px_70px_rgba(0,0,0,0.45)] hover:translate-y-[-6px] hover:scale-[1.02]">
